...
def main(board, index, iteration):
    ...
    if row not in range(1, (index + 1)) and column not in range(1, (index + 1)):
        return False, f"invalid input!,{player}"
        ...
        return False, f"You lost you turn {player}"
